...
<body>
    <nav class="navbar navbar-expand-lg fixed-top">
        <div class="container">
            <a class="navbar-brand fw-bold text-primary" href="{{ url('/') }}">Conciergerie Airbnb</a>
            ...
            <div id="navbarNav" class="collapse navbar-collapse">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a href="{{ url('/contact') }}" class="nav-link">Nous Contacter</a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <main class="mt-5 pt-4">
        <a href="https://wa.me/33612345678" target="_blank" class="whatsapp-float" title="Contactez-nous sur WhatsApp">
